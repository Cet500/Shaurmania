...
source:'<path d="M4.937 3.939L1 8.499l3.937 4.564L6 12 3 8.499 6 5zm6.126 0L10 5.002l3 3.503-3 3.497 1.063 1.063L15 8.505z"/>',strike:'<text x="50%" y="50%" text-anchor="middle" dy=".5ex" font-family="Dejavu Sans, Helvetica, Arial, sans-serif" font-size="15" font-weight="bold">S</text><path d="M1 7v1h14V7H1z"/>',subscript:'<path d="M11 10v1h3v1h-3v3h4v-1h-3v-1h3v-3zM1 3l3 5-3 5h2l3-5H4l3 5h2L6 8l3-5H7L4 8h2L3 3z"/>',superscript:'<path d="M11 1v1h3v1h-3v3h4V5h-3V4h3V1zM1 3l3 5-3 5h2l3-5H4l3 5h2L6 8l3-5H7L4 8h2L3 3z"/>',
...
youtube:'<path d="M2 2C1 2 0 3 0 4v8c0 1 1 2 2 2h12c1 0 2-1 2-2V4c0-1-1-2-2-2H2zm4 3l6 3-6 3V5z"/>'};c.icons.monocons=function(){var e={},g;return{create:function(a){a in f&&(e[a]=c.dom.parseHTML('<svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 16 16" unselectable="on">'+f[a]+"</svg>").firstChild,"color"===a&&(g=e[a].querySelector(".sce-color")));return e[a]},update:function(a,b){if(g){var h="inherit";!a&&b&&(h=b.ownerDocument.queryCommandValue("forecolor"));d.css(g,"fill",h)}},rtl:function(a){var b=
e.grip;b&&(a=a?"scaleX(-1)":"",d.css(b,"transform",a),d.css(b,"msTransform",a),d.css(b,"webkitTransform",a))}}};c.icons.monocons.icons=f})(document,sceditor);

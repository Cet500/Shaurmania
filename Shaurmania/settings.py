...
DATABASES = {
    "default": {
        ...
        "TEST": {
            "NAME": BASE_DIR / env( 'DATABASE_TEST_NAME' ),
        }
    }
}
...
IS_TEST_RUN = (
    any(arg.startswith('test') for arg in sys.argv) or  # manage.py test
    any('pytest' in arg for arg in sys.argv) or         # pytest entry
    os.environ.get('PYTEST_CURRENT_TEST') is not None   # pytest env var
)
